            ...
            @foreach ($wishlistItems as $item)
                <div class="wishlist-item">
                    ...
                    <div class="wishlist-actions">
                        ...
                        <a href="javascript:void(0)" class="btn btn-add-cart add-to-cart-btn"
                            data-id="{{ $item->product->id }}" title="Thêm vào giỏ hàng">
                            <i class="fas fa-shopping-cart"></i> Thêm
                        </a>

                        <a href="javascript:void(0)" class="btn btn-remove remove-from-wishlist"
                            data-id="{{ $item->product->id }}" title="Xóa khỏi danh sách yêu thích">
