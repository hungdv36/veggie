                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade active show" id="liton_tab_dashboard">
                                                <div class="ltn__myaccount-tab-content-inner">
                                                    ...
                                                    <p>Từ trang bảng điều khiển tài khoản của bạn, bạn có thể xem <span>các đơn hàng gần đây
                                                        </span>, quản lý <span>địa chỉ giao hàng và thanh toán</span>, và <span>chỉnh sửa mật khẩu cũng như thông tin tài khoản
                                                            </span>.</p>
                                                </div>
                                            </div>
                                                        ...
                                                        <form action="#" method="POST" id="update-account" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row mb-50">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" name="ltn__email" id="ltn__email" value="{{ $user->email }} ">
                                                                </div>
                                                                </div>
                                                                    <label for="ltn_address">Địa chỉ</label>
                                                                    <input type="text" name="ltn__adress" id="ltn__address" value="{{ $user->address }} readonly">
                                                                </div>                                                             
                                                            <div class="btn-wrapper">
                                                                <button type="submit"
                                                                    class="btn theme-btn-1 btn-effect-1 text-uppercase">Cập </button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
